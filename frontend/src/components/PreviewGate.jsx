    ...
    <div className="min-h-screen bg-[#F7F5F0] flex items-center justify-center px-6" data-testid="preview-gate">
      ...
      >
        ...
        <h1 className="font-display text-4xl sm:text-5xl tracking-tight mt-4 text-[#1A1A1A]">
          Sophie <span className="text-[#731F17]">&amp;</span> Ken
        </h1>
        ...
        <form onSubmit={submit} className="mt-8">
          ...
          <input
            ...
            className="w-full bg-transparent border-b-2 border-[#1A1A1A]/25 focus:border-[#731F17] outline-none py-3 font-body text-lg text-[#1A1A1A] transition-colors"
            autoComplete="off"
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-8 w-full font-label text-[0.7rem] tracking-[0.22em] uppercase bg-[#1A1A1A] text-[#F7F5F0] py-4 hover:bg-[#731F17] transition-colors disabled:opacity-60"
