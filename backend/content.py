...
CONTENT = {
    ...
    "invitation": {
        "hosts": "Dr. Eric Knochenhauer & Marie Knochenhauer",
        "request_line_one": "request the pleasure of your company",
        "request_line_two": "at the wedding of their daughter",
        "_status": "confirmed",
    },
    "issue": {
        "volume": "Vol. I",
    ...
    "ny_guide": {
        ...
        "body": "A few recommendations. A few warnings.",
        "map_title": "The Manhattan Plan",
        "map_caption": "A perfectly reasonable Saturday, on paper.",
        "map_note": "For actual recommendations, ask us.",
        "recommendations": [
            {"num": "01", "category": "Eat", "name": "Olive Garden, Times Square", "body": "New York has better Italian food. This has unlimited breadsticks.", "maps_query": "Olive Garden Times Square New York", "pin": {"x": 47, "y": 36}},
            {"num": "02", "category": "Eat", "name": "Sbarro, Herald Square", "body": "A New York slice, according to Michael Scott.", "maps_query": "Sbarro Herald Square New York", "pin": {"x": 45, "y": 42}},
            {"num": "03", "category": "See", "name": "M&M'S New York", "body": "Three floors of M&M's. There is an upstairs.", "maps_query": "M&M'S New York Times Square", "pin": {"x": 46, "y": 35}},
            {"num": "04", "category": "See", "name": "Madame Tussauds", "body": "Beyoncé is there. Sort of.", "maps_query": "Madame Tussauds New York", "pin": {"x": 45, "y": 38}},
            {"num": "05", "category": "See", "name": "The Central Park Pedicab Experience", "body": "Central Park, with a meter running.", "maps_query": "Central Park Pedicab Tours New York", "pin": {"x": 52, "y": 22}},
            {"num": "06", "category": "See", "name": "The Open-Top Sightseeing Bus", "body": "The same traffic. Better view.", "maps_query": "Hop-On Hop-Off Bus Times Square New York", "pin": {"x": 48, "y": 40}},
            {"num": "07", "category": "See", "name": "Every Costumed Character in Times Square", "body": "Take the picture. Then settle the terms.", "maps_query": "Times Square New York", "pin": {"x": 47, "y": 37}},
            {"num": "08", "category": "See", "name": "The Street CD Collection", "body": "You can still buy a CD on the street.", "note": "This is not a recommendation.", "maps_query": "Times Square New York", "pin": {"x": 50, "y": 48}},
            {"num": "09", "category": "Shop", "name": "Macy's Herald Square", "body": "Go in for one thing. See you in an hour.", "maps_query": "Macy's Herald Square New York", "pin": {"x": 44, "y": 43}},
            {"num": "10", "category": "Shop", "name": "A Times Square Souvenir Store", "body": "Buy the shirt. Wear it immediately.", "maps_query": "Times Square Souvenir Shop New York", "pin": {"x": 46, "y": 39}},
            {"num": "11", "category": "Walk", "name": "The Fifth Avenue Formation", "body": "Walk four across. Stop without warning. You'll fit right in.", "maps_query": "Fifth Avenue New York", "pin": {"x": 54, "y": 33}},
            {"num": "12", "category": "See", "name": "The Two-Observation-Deck Doubleheader", "body": "See Manhattan from above. Then verify from another angle.", "maps_query": "Top of the Rock New York", "pin": {"x": 49, "y": 45}},
            {"num": "13", "category": "Drink", "name": "A Times Square Rooftop Cocktail", "body": "A vodka soda, but with altitude.", "maps_query": "Rooftop Bar Times Square New York", "pin": {"x": 45, "y": 41}},
        ],
        "_status": "confirmed",
    },
    "attire": {
    ...
    "registry": {
        "published": True,
        "label": "Registry",
        "headline": "A Few Things We Like",
        "subhead": "Some useful. Some just very nice.",
        "entries": [
